...
The site opens with three interactive, full-screen statements before the main KeepRI site. It introduces free reasoning play, competition, meaningful prizes, and the proposed research business built around motivated players. Public status is Closed beta. Personal biographies, personal contact links, named games, game screenshots, and installation links are excluded.

Each scroll gesture or touch swipe advances one full-screen statement. Whole-sentence blends introduce an original competition arena. Player pieces circulate, podiums rise, perspective changes, and an engraved trophy appears. The same illustration responds to scrolling and four native buttons in the main site. The hero connects free play, mastery, competition and meaningful prizes. Competition/prize programs remain in development; the research pitch describes motivated effort as a thesis, with separately consented, controlled collections. Chapter links and a visible skip control remain available. After entry, the intro is removed, so scrolling upward stops at the main site. Research deliverables use native expandable disclosures. Everything remains readable without JavaScript; reduced-motion users get instant chapter changes. Without JavaScript, the intro falls back to three readable native sections.
