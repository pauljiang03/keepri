...
| --- | --- | --- |
| Reasoning assembly in the entrance | Original SVG/TypeScript generated by Codex for this project: `components/reasoning-assembly.tsx`, `lib/assembly-geometry.ts` | Custom coordinates, interlocking shapes, projection, materials and animation. No stock graphic, downloaded 3D model, or reference-site artwork was used. Conceptual illustration, not a current game. |
| Competition arena in the experience | Original SVG/TypeScript generated by Codex for this project: `components/competition-arena.tsx`, `lib/arena-geometry.ts` | Custom arena, pieces, podiums, trophy and animation. No stock graphic, downloaded model, or reference-site artwork was used. |
...
| DM Sans | Existing self-hosted font files | SIL OFL1.1; license retained in `public/fonts/DM-Sans-OFL.txt` and the public output. |
...
The two large illustrations are distinct and share only the established palette and dimensional drawing style. Virio supplied interaction/art-direction inspiration; its artwork and source were not copied. Tastemaker supplied workflow guidance; its illustration assets were not used.
