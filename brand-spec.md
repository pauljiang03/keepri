...
- Visual language: original code-native arena in `components/competition-arena.tsx`, with layered terraces, inlaid tracks, six player pieces, rising podiums and a faceted trophy. Four scenes connect discovery, improvement, competition and rewards. The arena is used only in the main experience. The entrance uses a separate original reasoning assembly in `components/reasoning-assembly.tsx`: interlocking pieces form a complete structure to represent building understanding. It depicts a conceptual competitive experience, with no specific game, actual player, prize amount, or observed performance.
