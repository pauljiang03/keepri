...
- Identity: KeepRI, Keep Reasoning Independently. Dot-free wordmark with an open corner framing RI, original RI orbital SVG, existing app favicon, self-hosted DM Sans, and paper/green/sage/gold/clay palette.
...
- Current design: constellation cover with diagonal page peel, split hero with a large perspective-projected orbital instrument beside stable text, philosophies, and directly visible industry content. No canvas, rotating headline, marquee, game screenshots, or separate rewards/closing section.
- Opening: show on every load or reload, including section hashes; wait for the visitor to choose entry before peeling. Hide the fixed cover permanently afterward. Header wordmark and Back to top stay on the main page. Reduced motion uses a still cover that also waits for entry. Runtime preference changes never replay it.
